<?php
/**
 * MODIFIED VERSION for media server only
 */
class ajax_list{
    ...
    public function display(){
        ...
        echo "<div class=\"row\">";
        echo "<div class=\"col s12 \"><input onkeyup=\"list_search('$this->id','$data_id',this.value);\" placeholder='Search' type='text' id='$search_id' class='form-control input-field' /></div>";
        if($count > 50){
            $back; $next;
